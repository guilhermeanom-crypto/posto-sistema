...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Viewport
    ref={ref}
    className={cn('fixed bottom-4 right-4 z-50 flex flex-col gap-2 w-[360px] max-w-[100vw]', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ref={ref}
    className={cn('ml-auto flex-shrink-0 rounded p-0.5 opacity-70 hover:opacity-100 transition-opacity', className)}
    toast-close=""
    {...props}
  >
    <X className="h-4 w-4" />
