...
def build():
    ...
    styled_run(p, ". Versão 2 · escopo refinado à luz da LAO 033/2020 literal e do TR SEMMA Guapó: a Renovação LAO ficou concentrada nas peças com fundamento literal; peças de boa prática consultiva não exigidas foram removidas e obrigações de compliance correlato (PGRS, NR-20, ANP, alvará sanitário) migraram para o Compliance Paralelo (§11). Integra plano técnico, racional de decisões, cronograma operacional (67 dias corridos · 4 fases), checklist cronológico e validação de auditoria. Protocolo-meta ", size=11, color=CINZA_7)
    styled_run(p, "26/06/2026 · meta acordada, mais defensiva que o mínimo legal de 120 dias (24/08/2026).", size=11, color=CINZA_9, bold=True)
    ...
    lede(doc, "O Auto Posto América opera sob a LAO 033/2020, vencimento 23/12/2026. "
         "O mínimo legal exigido pela condicionante 3.11 da LAO é de 120 dias de antecedência "
         "(piso regulatório em 24/08/2026). O plano adota 26/06/2026 (180 dias) como meta "
         "operacional acordada — mais defensiva que o mínimo legal, não obrigação legal em si. "
         "Janela de execução de 67 dias a partir de 20/04. Base documental suficiente para "
         "iniciar a estruturação.",
         ["LAO 033/2020", "23/12/2026", "mínimo legal", "120 dias",
          "24/08/2026", "26/06/2026 (180 dias)", "meta operacional acordada"])

    heading_h3(doc, "Escopo refinado após análise documental da LAO 033/2020")
    body_p(doc, "Esta versão 2 do Documento Consolidado reflete refinamento de escopo realizado "
           "após confrontação das atividades planejadas contra as condicionantes literais da "
           "LAO 033/2020 e do Termo de Referência da SEMMA Guapó. A versão 1 incluía peças "
           "que são boas práticas consultivas mas não são exigências formais do processo de "
           "renovação (por exemplo, investigação ambiental confirmatória, análise de risco, "
           "sondagens SPT, investigação detalhada, plano de intervenção, instalação de novos "
           "poços de monitoramento). Nesta versão 2, o escopo da renovação foi concentrado "
           "exclusivamente nas peças com fundamento literal na LAO ou TR oficial. Peças de "
           "compliance correlato (PGRS, NR-20, cadastro ANP, alvará sanitário) foram "
           "realocadas para a frente de Compliance Paralelo (§11), onde permanecem como "
           "obrigações do empreendimento, porém fora do caminho crítico do protocolo de "
           "renovação.",
           ["versão 2", "refinamento de escopo", "fundamento literal na LAO ou TR oficial",
            "Compliance Paralelo (§11)", "fora do caminho crítico"])

    t = table_hdr(doc, ["Prazo", "Data", "Observação"], [4.8, 3.2, 9.5])
    add_row(t, ["Meta acordada · 180 dias antes", "26/06/2026",
                "Submissão do dossiê no Processo SEMMA 22760/2020. Meta operacional mais defensiva que o mínimo legal. Janela de execução 67 dias."],
            bold_cols=[1], mono_cols=[1])
    add_row(t, ["Mínimo legal CP 3.11 (120 dias)", "24/08/2026",
                "Piso regulatório efetivo da LAO (condicionante 3.11). Obrigação legal: protocolar até esta data."],
            zebra=True, bold_cols=[1], mono_cols=[1])
    add_row(t, ["Prazo regulatório · vencimento LAO", "23/12/2026",
                "Data-limite absoluta. A meta de 26/06 preserva 180 dias de folga; o mínimo legal preserva 120 dias."],
            bold_cols=[1], mono_cols=[1])
    doc.add_paragraph()
    ...
    pts = [
        ...
        ("Contratação de serviços técnicos obrigatórios: laboratório credenciado para RCA semestral, empresa terceirizada para elaboração do MCO e Anexos CONAMA 273 (via ART de terceiro Eng. Civil/Ambiental sob coordenação CRBio da Hábilis), e fornecedores de manutenção do SAO/coleta de resíduos (Bauer, Limpmil, Ecofenix).", []),
    ...
    lede(doc, "A gestão do Auto Posto América está estruturada em 3 frentes contratadas + 1 "
         "frente paralela de continuidade. O pacote formalizado da Renovação LAO concentra-se "
         "nas peças com fundamento literal na LAO 033/2020 e no TR SEMMA Guapó. A Frente 04 · "
         "Compliance Paralelo (ANP · IBAMA · NR-20 · PNRS · alvará sanitário · monitoramentos) "
         "foi mapeada como frente permanente de gestão, fora do caminho crítico do protocolo — "
         "apresentada no §11.",
         ["3 frentes contratadas + 1 frente paralela de continuidade",
          "fundamento literal na LAO 033/2020 e no TR SEMMA Guapó",
          "fora do caminho crítico do protocolo", "§11"])

    t = table_hdr(doc, ["Frente", "Órgão / Norma", "Papel"], [4.8, 4.5, 8.0])
    rows = [
        ("01 · Uso do Solo (pré-requisito)", "Prefeitura de Guapó",
         "Destrava o protocolo. Sem certidão vigente, a SEMMA não recebe o dossiê."),
        ("02 · Renovação LAO (objeto central)", "SEMMA Guapó · Proc. 22760/2020",
         "Dossiê técnico e relatório da Hábilis; peças com fundamento literal na LAO/TR."),
        ("03 · Condicionantes", "LAO 033/2020 · Extrato 05/2024",
         "Plano de atendimento das 28 CPs; SEMMA avalia o histórico antes de deferir."),
        ("04 · Compliance Paralelo (§11)", "ANP · IBAMA · NR-20 · PNRS · Sanitário",
         "Frente permanente fora do caminho crítico da renovação; autuação correlata poderia contaminar o processo principal."),
    ]
    ...
    body_p(doc, "Três frentes contratadas + 1 frente paralela de continuidade (§11). O uso do solo "
           "antecede a renovação. As condicionantes sustentam o dossiê técnico. O compliance "
           "paralelo roda em cadência própria, protegendo a integridade regulatória contra "
           "autuações correlatas.")
    ...
    for item in [
        "Requerimento modelo SEMMA · Publicação CONAMA 006/86 (2 jornais)",
        "MCO atualizado · Anexo IX CEMAM 029/2018 (+ART de terceiro)",
        "Anexos I e II Res. CONAMA 273/2000 (+ART de terceiro)",
        "Relatório técnico consolidado (+ART Hábilis CRBio)",
        "RCA semestral · coleta 22/05 · laudo 03/06 · CP 4.4",
        "PAE · Plano de Atendimento a Emergências (CP 4.9)",
        "NFs semestrais de manutenção SAO e coleta de resíduos · Certificados de coleta 3 anos (CP 4.5/4.6/4.7)",
    ...
    heading_h3(doc, "3.2.1 · Visita técnica de campo (12/05/2026) · validação prévia à produção das peças")
    body_p(doc, "Inspeção técnica de campo agendada para 12/05/2026. NÃO é entregável formal do "
           "dossiê — é ferramenta de diagnóstico interno que antecede e valida a produção das "
           "peças obrigatórias (MCO, Anexos I/II CONAMA 273, RCA semestral, PAE, Plano das 28 "
           "condicionantes, validação das plantas, levantamento hídrico que define o regime da "
           "outorga no Veredas).",
           ["12/05/2026", "NÃO é entregável formal do dossiê",
            "ferramenta de diagnóstico interno"])

    t = table_hdr(doc, ["Eixo", "Foco", "Subsidia (peça formal)"], [1.2, 7.5, 7.5])
    eixos = [
        ("1", "Implantação e imóvel (layout × plantas, SIRGAS 2000, RGI) + APP/RL/CAR + vegetação remanescente", "Validação de plantas · croqui · MCO · Uso do Solo"),
        ("2", "Armazenamento, abastecimento + tubulações subterrâneas + levantamento hídrico (captação → regime outorga)", "MCO · NFs · CONAMA 319 · Requerimento Veredas 13/05"),
        ("3", "Efluentes, drenagem e esgoto — auditoria da reprovação RCA 2024 + conferência de poços existentes (CP 4.4)", "RCA 03/06 · anuência saneamento"),
        ("4", "Resíduos e armazenamento · interferências enterradas", "CP 4.6/4.7 · plano de recomposição CPs"),
        ("5", "Segurança, documentos, rotina operacional + entrevista estruturada com operador (5 blocos: SAO/RCA · operações · incidentes · calibrações · gestão)", "PAE · Compliance Paralelo · plano de recomposição CPs · Risco 02"),
    ]
    ...
    rows_status_mco = [
        ...
        ("ART do MCO", "Terceiro Eng. Civil/Ambiental",
         "Modelo padrão Hábilis: subcontrato com ART de terceiro sob coordenação CRBio · contratação até 10/05 · ART emitida 27-28/05."),
    ]
    ...
    rows_insumos = [
        ...
        ("Eixo 4 · Resíduos",
         "Armazenamento resíduos perigosos · coleta · pontos críticos",
    ...
    heading_h4(doc, "Atribuição da ART · modelo padrão Hábilis")
    body_p(doc, "A Hábilis subcontrata a elaboração do MCO e dos Anexos CONAMA 273 a terceiro "
           "Eng. Civil ou Ambiental sob coordenação CRBio (Hábilis não possui Eng. Civil/"
           "Ambiental interno). O terceiro emite a ART específica da peça; a Hábilis coordena, "
           "integra e assina o Relatório Consolidado via RT CRBio próprio. Custo de terceiro "
           "estimado R$ 8-15k (contratação até 10/05 · ART emitida 27-28/05).",
           ["subcontrata", "terceiro Eng. Civil ou Ambiental sob coordenação CRBio",
            "10/05", "27-28/05"])
    doc.add_paragraph()
    ...
    rows_riscos_mco = [
        ...
        ("② Atraso na contratação do terceiro (ART)",
         "Eng. Civil/Ambiental parceiro indisponível no período",
         "Lista de parceiros pré-negociada até 05/05 · contrato firmado até 10/05 · prazo ART 5-15 dias úteis."),
        ...
        ("⑤ Formato técnico não-conforme CP 3.12",
         ...
         "Plantas 05/2024 já estão em .dwg — basta validar formato e completar shapefile + UTM SIRGAS 2000 · sem necessidade de redesenho completo."),
    ]
    ...
    callout(doc, "Leitura prática · o MCO como peça ancorada",
            "O MCO não existe isoladamente — ele é ancorado em duas dependências críticas: "
            "inspeção 12/05 (dados de campo) e NFs/fichas dos equipamentos até 18/05 (ficha "
            "técnica dos tanques). Se qualquer uma falhar, o MCO de 28/05 escorrega. Mitigação: "
            "monitoramento diário das dependências na semana de 13-18/05. Uma vez entregue, o "
            "MCO destrava os Anexos I/II CONAMA 273 (29/05 · §3.2.4) e alimenta o Relatório "
            "Consolidado (19/06).",
            kind="verde",
            bold_body_parts=["duas dependências críticas", "12/05", "18/05",
    ...
    rows_classes = [
        ...
        ("Classe 2 (médio risco)",
         ...
         "Exigências padrão · monitoramento reforçado · atendimento padrão das CPs 4.4/4.8."),
        ("Classe 3 (alto risco)",
    ...
    rows_riscos_anx = [
        ...
        ("④ ART esquecida",
         ...
         "Anexos têm ART própria · emitida pelo mesmo terceiro Eng. Civil/Ambiental junto com a do MCO (27-28/05)."),
    ...
    cps_orient = [
        ...
        ("3.8", "Suspensão automática se demais licenças vencerem.", "Ação", "⚠ Parcial",
         "AVCB vigente 20/10/2026 ✓. Alvará sanitário [VALIDAR · Compliance Paralelo §11]. DURH002737 vencida 09/12/2023 (regularização Veredas em 13/05)."),
        ...
        ("3.10", "Manter atualizado ANP e AVCB.", "Ação", "⚠ Parcial",
         "AVCB Cercon 161726 ✓. Cadastro ANP do revendedor realocado para Compliance Paralelo (§11)."),
        ...
        ("3.12", "Premissas de relatórios: .jpg + ABNT · fotos datadas UTM SIRGAS 2000 · .pdf/.dwg · shapefile · RT + ART.", "Ação", "⚠ Parcial",
         "Atendido no Relatório Consolidado 19/06. Plantas 05/2024 já em .dwg · complementação de shapefile + UTM SIRGAS 2000."),
    ]
    ...
    cps_espec = [
        ...
        ("4.9", "Plano de Gerenciamento de Risco: integridade · emergência · treinamento.", "Contínua", "⚠ Parcial",
         "PGR 2024 ✓. Validar emergência (PAE 05/06) e treinamento (inspeção Eixo 5). Capacitação NR-20 tratada no Compliance Paralelo (§11)."),
    ...
    rows_falta = [
        ...
        ("4", "Poços de monitoramento · conferência", "até 22/05",
         "CP 4.4 exige BTEX e PAH nos poços. Conferir existência e operacionalidade na inspeção 12/05 · Eixo 3. Premissa: poços já existem e atendem CP 4.4 como infraestrutura instalada; caso contrário, registrar em relatório."),
    ...
    callout(doc, "Conclusão objetiva · status do RCA 2026",
            ...
            "sequência diagnóstico → adequação → coleta → laudo. Em 22/04/2026, estamos no marco "
            "zero: as ações da próxima semana (procuração 23/04 · CNPJ 24/04) destravam a "
            "visita 12/05, que é o ponto em que a consolidação começa de fato. Cronograma até "
            "03/06 é factível se Hip. A ou C. Se Hip. B (obra estrutural), RCA consolidado "
            "escorrega para depois do protocolo e o dossiê é submetido com plano corretivo em "
            "anexo — cenário transparente, não inviabilizante.",
            kind="verde",
    ...
    body_p(doc, "Frentes regulatórias correlatas tratadas fora do caminho crítico do protocolo: "
           "ANP (cadastro de revendedor + declarações · CP 3.10), IBAMA (CTF/APP + RAPP + TCFA), "
           "NR-20 (PGR + capacitação da brigada), PNRS/PGRS (Lei 12.305/2010 · MTR), alvará "
           "sanitário municipal (se aplicável em zona rural) e monitoramentos contínuos. "
           "Cadência própria, independente do cronograma da renovação. Detalhamento no §11.",
    ...
    fases = [
        ("F1 · Estruturação", "20/04 → 08/05", "19",
         "Consolidar uso do solo e estruturar base técnica. Entregáveis: verificação da certidão, verificação de outorga, requerimento municipal, contratação de terceiro para ART MCO/Anexos 273, análise documental."),
        ("F2 · Consolidação", "09/05 → 30/05", "22",
         "Validar realidade física e repor base técnica. Entregáveis: inspeção técnica de campo (12/05), protocolo Veredas (13/05), nova coleta RCA (22/05), MCO atualizado (28/05), Anexos I/II CONAMA 273 (29/05), Plano das 28 CPs (30/05)."),
        ("F3 · Execução e Evidência", "31/05 → 19/06", "20",
         "Executar atendimento das condicionantes e produzir relatório. Entregáveis: RCA semestral (03/06), PAE (05/06), recomposição das CPs parciais (12/06), relatório consolidado (19/06)."),
    ...
    checklist = [
        ...
        ("27/04", "Enquadramento do imóvel + CAR (confirmado rural conforme LAO item 1.2)", "Hábilis", "F1",
         "Imóvel classificado como Zona Rural (LAO 033/2020 item 1.2). Resolve: (1) CAR obrigatório · validar inscrição; (2) ART Uso do Solo via RT Agronômica."),
        ("27/04", "ART específica para Uso do Solo", "Hábilis · RT Agronômica", "F1",
         "ART pela Hábilis via RT Engenharia Agronômica."),
        ...
        ("04/05", "Publicação do pedido de licenciamento (CONAMA 006/1986)", "Hábilis", "F1",
         "DOE/GO + jornal de grande circulação. 30 dias para contestação pública."),
        ("05/05", "Contratação de terceiro Eng. Civil/Ambiental para ART do MCO e Anexos CONAMA 273", "Cliente", "F1",
         "Modelo padrão Hábilis · subcontratação sob coordenação CRBio. Faixa R$ 8-15k."),
        ("08/05", "Análise documental consolidada", "Hábilis", "F1",
         "Fechamento da triagem do lote 14/04 e identificação de lacunas."),
        ("10/05", "Mapeamento documental das condicionantes parciais/pendentes", "Hábilis", "F1",
         "Plano de recomposição por CP."),
        ("12/05", "Validação técnica prévia em campo · 5 eixos", "Hábilis", "F2",
         "Diagnóstico interno · NÃO entregável formal. Conteúdo detalhado em §3.2.1. Subsidia produção das peças."),
        ("12/05", "Validação das plantas em campo", "Hábilis", "F2",
         "Quadro de Áreas, UTM SIRGAS 2000, APP, Reserva Legal. Plantas 05/2024 em .dwg — basta validar."),
        ("12/05", "Levantamento hídrico · define regime da outorga", "Hábilis", "F2",
         "Eixos 1-2: identifica captação direta. Sem captação → dispensa simplificada; com captação → processo completo."),
        ("13/05", "Protocolo novo de outorga via Sistema Veredas", "Hábilis", "F2",
         "Dia útil seguinte à validação de 12/05. Dentro do prazo 15/07/2026 (IN 15/2026 SEMAD). Gera certidão de tramitação para o dossiê LAO."),
        ("15/05", "Contratação de laboratório acreditado para RCA semestral", "Cliente", "F2",
         "Indicação Hábilis · acreditação INMETRO vigente."),
        ...
        ("20/05", "Contratos + NFs semestrais de manutenção (Ecofenix, Bauer, Limpmil) · CP 4.5/4.6/4.7", "Cliente", "F2",
         "Validar vigência do licenciamento + certificados de coleta de óleo usado dos últimos 3 anos."),
        ("22/05", "Nova coleta de efluentes · RCA", "Terceiro · Lab", "F2",
         "Só após adequação SAO (diagnóstico 12/05). ART do químico."),
        ("25/05", "Anuência de saneamento ou laudo de fossa (condicional)", "Hábilis", "F2",
         "Conforme diagnóstico de 12/05 (item 11 TR)."),
        ("28/05", "Atualização do MCO · Anexo IX CEMAM 029/2018 (+ART)", "Terceiro sob coord. Hábilis", "F2",
         "Posterior à validação de 12/05. ART via terceiro Eng. Civil/Ambiental sob coordenação CRBio."),
        ("29/05", "Anexos I e II da Resolução CONAMA 273/2000 (+ART)", "Terceiro sob coord. Hábilis", "F2",
         "Item 23 TR. Mesmo terceiro do MCO."),
        ...
        ("03/06", "RCA semestral · Anexo XI CEMAM 029/2018", "Hábilis", "F3",
         "Análises SAO: pH, turbidez, O&G, sólidos, DBO, DQO, MBAS, metais, TPH, BTEX/PAH. ART via RT Ambiental (CRBio)."),
        ("05/06", "PAE · Plano de Atendimento a Emergências", "Hábilis", "F3",
         "Cenários (vazamentos, incêndios, derramamento). ART via RT Ambiental (CRBio)."),
        ("12/06", "Recomposição documental das condicionantes parciais", "Hábilis", "F3",
         "Conforme Plano de Atendimento de 30/05."),
        ("19/06", "Relatório técnico consolidado (+ART Hábilis CRBio)", "Hábilis", "F3",
         "Peça integradora. Laudos específicos mantêm ART dos RTs próprios."),
        ...
        ("26/06", "PROTOCOLO no Processo SEMMA 22760/2020", "Hábilis", "F4",
         "Submissão do dossiê completo. Marco final da meta acordada (180d antes do vencimento)."),
    ]
    ...
    resp_blocks = [
        ...
        ("2 · Cliente (Grupo Z+Z) · decisão e liberação", AZUL_BG, "0D47A1",
         ["Confirmação formal da certidão de uso do solo existente",
          "Contratação de terceiro Eng. Civil/Ambiental para ART do MCO e Anexos CONAMA 273",
          "Contratação de laboratório acreditado para o RCA semestral",
        ...
        ("3 · Terceiros · execução obrigatória", CINZA_BG, "6C6C70",
         ["SEMMA Guapó, órgão licenciador",
          ...
          "SEMAD/GO, outorga via Sistema Veredas",
          "RT Eng. Civil/Ambiental contratado, ART do MCO e Anexos CONAMA 273",
          "Laboratório acreditado, análises do RCA semestral (CP 4.4)",
          "Bauer/Limpmil/Ecofenix, manutenção SAO e coleta de resíduos (CP 4.5/4.6/4.7)",
          "Jornais DOE/GO + grande circulação, publicação CONAMA 006/86"]),
    ...
    # ===== §07 CAPEX =====
    heading_section(doc, "07", "Investimento · CAPEX da renovação LAO")
    lede(doc, "O investimento da renovação LAO é apresentado como faixa estreita (piso · teto), "
         "concentrada nas peças com fundamento literal na LAO 033/2020 e no TR SEMMA Guapó. "
         "Sem contingências escondidas; sem teto inflado com investigação confirmatória, análise "
         "de risco ou remediação. O Compliance Paralelo (§11) é frente separada, opcional, com "
         "orçamento anual próprio.",
         ["faixa estreita", "peças com fundamento literal",
          "Sem contingências escondidas", "Compliance Paralelo (§11)"])

    tc = doc.add_table(rows=1, cols=2)
    c = tc.cell(0, 0); set_cell_shading(c, CINZA_BG); set_cell_border(c, left=(18, "1B5E20"))
    styled_run(c.paragraphs[0], "RENOVAÇÃO LAO · TOTAL", size=8, color=CINZA_5, bold=True, mono=True)
    styled_run(c.add_paragraph(), "R$ 1.280k – 1.330k", size=20, color=VERDE, bold=True, mono=True)
    styled_run(c.add_paragraph(),
               "Somente peças obrigatórias: taxas oficiais, publicação CONAMA 006/86, serviços "
               "terceiros obrigatórios (RCA · MCO/CONAMA 273 via ART de terceiro · manutenção "
               "SAO · publicação), coordenação Hábilis, ajustes operacionais obrigatórios. "
               "Honorários Hábilis podem estar incluídos aqui ou em contrato separado, conforme "
               "aditivo.",
               size=9, color=CINZA_7)

    c = tc.cell(0, 1); set_cell_shading(c, CINZA_BG); set_cell_border(c, left=(18, "0D47A1"))
    styled_run(c.paragraphs[0], "COMPLIANCE PARALELO · FRENTE SEPARADA", size=8, color=CINZA_5, bold=True, mono=True)
    styled_run(c.add_paragraph(), "R$ 20k – 60k / ano", size=20, color=AZUL, bold=True, mono=True)
    styled_run(c.add_paragraph(),
               "Frente permanente, fora do caminho crítico do protocolo. Inclui PGRS + NR-20 + "
               "atualizações ANP + alvará sanitário + monitoramentos. Orçamento anual em bases "
               "recorrentes (§11). Bônus · opcional.",
               size=9, color=CINZA_7)
    doc.add_paragraph()

    heading_h3(doc, "7.1 · Composição detalhada do CAPEX da renovação LAO")
    body_p(doc, "O total da renovação cobre 5 categorias. Valores são estimativas 2026 · "
           "cotações formais em F1-F2.",
           ["5 categorias"])

    t = table_hdr(doc, ["Categoria", "Faixa estimada", "Composição"], [4.5, 3.0, 9.5])
    rows_cat = [
        ("① Taxas oficiais", "R$ 40k–80k",
         "DUAM SEMMA · taxa Renovação LAO · Prefeitura (Certidão Uso do Solo) · SEMAD/GO (Veredas · DUAM) · CND Municipal + Estadual · cartório (procuração + firmas)."),
        ("② Publicação CONAMA 006/86", "R$ 1,2k–2,8k",
         "DOE/GO + jornal de grande circulação (O Popular · Diário da Manhã ou regional). Detalhamento em §3.2.2."),
        ("③ Serviços terceiros obrigatórios", "R$ 80k–180k",
         "Laboratório RCA semestral · terceiro Eng. Civil/Ambiental para MCO+Anexos 273 (ART) · manutenção SAO (Bauer/Limpmil/Ecofenix) · publicação contratada."),
        ("④ Produção de peças e coordenação Hábilis", "R$ 150k–300k",
         "Relatório técnico consolidado · coordenação CRBio · interlocução SEMMA · PAE · RCA · Plano das 28 CPs · integração do dossiê."),
        ("⑤ Ajustes operacionais obrigatórios", "R$ 30k–100k",
         "Limpeza SAO pré-coleta RCA · reposição kit de contenção · formatos técnicos das plantas (shapefile + UTM SIRGAS 2000 · plantas 05/2024 já em .dwg · apenas complementação)."),
        ("Base operacional + reservas", "restante até o teto",
         "Reserva para cotações específicas do interior de Goiás (sobretaxa rural BR-060 km 203) e pequenas adequações não mapeadas."),
        ("TOTAL RENOVAÇÃO LAO", "R$ 1.280k–1.330k",
         "Faixa estreita · sem contingências escondidas · sem peças de boa prática consultiva que não têm fundamento literal na LAO/TR."),
    ]
    for i, row in enumerate(rows_cat):
        is_total = (i == len(rows_cat) - 1)
        add_row(t, list(row), zebra=(i % 2 == 1 and not is_total), bold_cols=[0], mono_cols=[1], is_total=is_total)
    doc.add_paragraph()

    callout(doc, "Delimitação do CAPEX · dentro e fora",
            "DENTRO da renovação LAO: taxas SEMMA/Prefeitura/SEMAD/cartório · publicação CONAMA "
            "006/86 · laboratório RCA · terceiro Eng. Civil/Ambiental para ART do MCO/Anexos 273 "
            "· manutenção SAO (Bauer/Limpmil/Ecofenix) · coordenação Hábilis · ajustes "
            "operacionais obrigatórios. FORA da renovação LAO (escopo refinado v2): investigação "
            "ambiental confirmatória · sondagens SPT · análise de risco · investigação detalhada "
            "(NBR 16210) · plano de intervenção (NBR 16784) · remediação · instalação de novos "
            "poços de monitoramento · teste de estanqueidade de contingência (mantém laudo "
            "10/2024 em vigor). EM FRENTE PARALELA (§11): PGRS · NR-20 · cadastro ANP · alvará "
            "sanitário · monitoramentos anuais.",
            kind="verde",
            bold_body_parts=["DENTRO da renovação LAO:", "FORA da renovação LAO (escopo refinado v2):",
                             "EM FRENTE PARALELA (§11):"])

    heading_h3(doc, "7.2 · Cotações a serem indicadas pela Hábilis")
    body_p(doc, "Para cada serviço terceirizado obrigatório, a Hábilis indica ao Grupo Z+Z 2-3 "
           "fornecedores com cotação formal · o Cliente decide a contratação.",
           ["2-3 fornecedores"])

    t = table_hdr(doc, ["#", "Serviço", "Escopo", "Norma", "Cotações", "Faixa", "Observação"],
                   [0.6, 2.6, 3.5, 2.2, 1.6, 1.8, 4.7])
    rows_cotacao = [
        ("A", "Laboratório acreditado para RCA semestral",
         "Análise efluente · parâmetros CP 4.4 (pH · turbidez · O&G · SS · DBO · DQO · OD · MBAS · metais · TPH · BTEX/PAH)",
         "INMETRO · Anexo XI CEMAM 029",
         "2-3 laboratórios", "R$ 8k-18k",
         "Acreditação INMETRO vigente · ART químico · obrigatório (CP 4.4)"),
        ("B", "Manutenção SAO + coleta resíduos",
         "Limpeza SAO · coleta areias oleosas · borra · óleo usado",
         "CONAMA 362/05 · CP 4.5/4.6",
         "Bauer + Limpmil + Ecofenix", "R$ 15k-40k",
         "Validar licenciamento + certificação ANP · cotação atualizada · obrigatório"),
        ("C", "RT Externo Eng. Civil/Ambiental para ART MCO + Anexos 273",
         "ART do MCO (28/05) + ART dos Anexos I/II CONAMA 273 (29/05)",
         "Res. CONFEA 218/73 + 1010/05",
         "2-3 parceiros", "R$ 8k-15k + ART",
         "Modelo padrão Hábilis · subcontratação sob coordenação CRBio · contratação até 10/05"),
        ("D", "Publicação CONAMA 006/86",
         "Publicação do pedido em 2 veículos (DOE/GO + grande circulação)",
         "CONAMA 006/86 · item 6 TR SEMMA",
         "Jornais oficiais", "R$ 1,2k-2,8k",
         "Obrigatório · publicar 04/05 · detalhamento §3.2.2"),
    ]
    ...
    callout(doc, "Orientação de boa prática · 3 cotações por serviço",
            "A Hábilis indica ao Grupo Z+Z no mínimo 2-3 fornecedores para cada serviço acima. "
            "Cotações apresentadas em formato comparativo (escopo · preço · prazo · "
            "certificações · experiência) para decisão com critério objetivo.",
            kind="verde",
            bold_body_parts=["2-3 fornecedores", "formato comparativo"])
    ...
    t = table_hdr(doc, ["Data-limite", "Ação", "Responsável", "Insumo/Dependência"],
                   [2.5, 6.0, 3.0, 5.5])
    rows_cron = [
        ("até 05/05", "Cotações RT Externo MCO + Anexos 273 (C)",
         "Hábilis · indicação", "2-3 parceiros pré-qualificados"),
        ("05/05", "Contratação do terceiro Eng. Civil/Ambiental",
         "Cliente · decisão", "Prazo ART 5-15 dias úteis · emitida 27-28/05"),
        ("até 15/05", "Cotações laboratório RCA (A)",
         "Hábilis · indicação", "Antes da coleta 22/05"),
        ("15/05", "Contratação laboratório acreditado",
         "Cliente · decisão", "Mobilização coleta RCA 22/05"),
        ("até 20/05", "Validação contratos Bauer/Limpmil/Ecofenix (B)",
    ...
    lede(doc, "Seis cenários podem empurrar o protocolo. Todos previsíveis, todos com gatilho "
         "de contingência definido. Escopo refinado v2 removeu riscos associados a peças não "
         "exigidas pela LAO (investigação detalhada, remediação).",
         ["Seis cenários", "previsíveis", "gatilho de contingência"])

    t = table_hdr(doc, ["#", "Risco", "Gatilho", "Impacto", "Contingência"],
                  [0.8, 4.2, 3.6, 4.2, 4.2])
    riscos = [
        ("01", "RCA 2026 reprovado · disfunção SAO (3 hipóteses de causa)",
         "Nova análise efluentes com O&G >20 mg/L · histórico 2024 = 64 mg/L (3,2× limite). Diagnóstico causal via validação técnica 12/05 Eixo 3.",
         ...
         "Diagnóstico prévio 12/05 via Eixo 3 + Eixo 5 (entrevista operador) define a hipótese · Hip. A: Bauer/Limpmil limpeza até 20/05 · Hip. B: plano corretivo no dossiê · Hip. C: ajuste hidráulico com ART até 25/05. Coleta do RCA só após adequação."),
        ("02", "Certidão Uso do Solo > 45d",
        ...
        ("03", "Cliente atrasa contratação",
         "Terceiro Eng. Civil/Ambiental não contratado até 05/05 ou laboratório até 15/05",
         "ART MCO/Anexos 273 escorrega. Laudos empilham em F3.",
         "Retorno em 5 dias úteis (§06). Alerta D-5 de cada contratação."),
        ("04", "AVCB exige renovação",
        ...
        ("05", "Outorga rebaixada para processo completo",
         "Validação 12/05 (Eixos 1-2) identifica captação direta (poço/mina/cisterna)",
        ...
        ("06", "SEMMA contesta Laudo de Estanqueidade 10/2024",
         ...
         "Próximo ciclo bianual regular em 10/2026 (Opção B · plano principal · §3.3.3). Se contestado, nova empresa com INMETRO vigente em 30-60 dias."),
    ]
    ...
    body_p(doc, "Mesmo que um cenário se materialize, a janela entre 26/06 (meta acordada) e "
           "24/08 (mínimo legal CP 3.11) reserva 59 dias de folga regulatória. A janela entre "
           "26/06 e 23/12 (vencimento LAO) reserva 180 dias. O mínimo legal é a obrigação; a "
           "meta de 26/06 é apenas mais defensiva.",
           ["mínimo legal CP 3.11", "59 dias de folga", "180 dias"])
    ...
    heading_h3(doc, "Datas-âncora oficiais")
    ...
    ancoras = [
        ...
        ("Validação técnica prévia de campo (F2)", "12/05/2026", "5 eixos · Seção 3.2.1 · diagnóstico interno"),
        ("Protocolo Veredas (F2 · Hábilis · pós-validação)", "13/05/2026", "Requerimento + memorial + plantas no Veredas, dia útil seguinte à validação 12/05"),
        ...
        ("Protocolo SEMMA · META ACORDADA", "26/06/2026", "Processo SEMMA 22760/2020 · 180 dias antes · meta operacional mais defensiva"),
        ("Protocolo mínimo legal (CP 3.11 · 120d)", "24/08/2026", "Piso regulatório efetivo · obrigação legal"),
    ...
    for titulo, texto in [
        ("Teste 1 · Ancoragem normativa",
         ...
         "(CONAMA 006/86, 273/2000, 319/2002, 362/2005 · CEMAM 029/2018 · NBR 16795/2019 · "
         "Portarias INMETRO · IN 15/2026 SEMAD) tem aplicação justificada?"),
        ("Teste 2 · Rastreabilidade contra LAO/TR literal",
         "Todas as peças do dossiê têm fundamento literal na LAO 033/2020 ou no TR SEMMA Guapó? "
         "As 28 CPs estão mapeadas (10 regras declaratórias + 18 ações auditáveis, sendo 6 atendidas "
         "/ 10 parciais / 2 pendentes)?"),
        ("Teste 3 · Dependências explicitadas",
         "Cada marco tem dependência a montante e a jusante? Os 6 riscos mapeados (§08) têm "
         "responsável nomeado e prazo de acionamento?"),
        ("Teste 4 · Margem regulatória suficiente",
         "A janela 26/06 → 24/08 (mínimo legal) reserva 59 dias de folga sobre o piso regulatório? "
         "A janela 26/06 → 23/12 (vencimento) reserva 180 dias? O CAPEX tem faixa estreita e "
         "escopo refinado? As cadências de Compliance Paralelo estão acordadas (§11)?"),
    ]:
        callout(doc, titulo, texto, kind="verde")

    # ===== §10 CONCLUSÃO =====
    heading_section(doc, "10", "Conclusão Técnica")
    lede(doc, "Processo viável dentro da janela de 67 dias corridos até a meta acordada em "
         "26/06/2026 (180 dias antes do vencimento da LAO), com folga adicional até 24/08/2026 "
         "(mínimo legal CP 3.11 · 120 dias). Escopo refinado v2: concentrado nas peças com "
         "fundamento literal na LAO/TR. Compliance Paralelo (§11) tratado em frente separada. "
         "Cumprimento depende de organização documental e decisão tempestiva do cliente.",
         ["67 dias corridos", "26/06/2026", "180 dias antes", "mínimo legal CP 3.11"])
    ...
    heading_h3(doc, "2 · Meta acordada 180 dias antes · mínimo legal é 120 dias")
    body_p(doc, "Protocolo fixado em 26/06/2026 preserva 180 dias de margem antes do vencimento "
           "em 23/12/2026. A obrigação legal efetiva (CP 3.11) é apenas 120 dias (24/08/2026); "
           "26/06 é meta operacional mais defensiva, não obrigação legal.")
    ...
    body_p(doc, "Quatro pontos concentram o risco: outorga via Veredas e AVCB, contratação do "
           "terceiro Eng. Civil/Ambiental para ART do MCO e Anexos 273 em F1, contratação dos "
           "demais terceiros em meados de maio, retorno em 5 dias úteis.")

    callout(doc, "Síntese final",
            "O Auto Posto América tem processo em condução ordenada, base documental funcional "
            "e escopo refinado alinhado à LAO/TR literal. A antecipação de 180 dias antes do "
            "vencimento é a postura mais defensiva (a obrigação legal é 120 dias). Meta "
            "operacional: protocolo em 26/06/2026.",
            kind="verde",
            bold_body_parts=["condução ordenada", "escopo refinado", "180 dias", "120 dias", "26/06/2026"])
    ...
    for i, row in enumerate([
        ...
        ("Contratação de terceiro Eng. Civil/Ambiental para ART do MCO e Anexos 273", "Cliente", "05/05/2026"),
        ("Validação técnica prévia em campo · 5 eixos + levantamento hídrico", "Hábilis", "12/05/2026"),
        ("Protocolo novo via Sistema Veredas (pós-validação · §15)", "Hábilis", "13/05/2026"),
        ("Contratação do laboratório acreditado para RCA semestral", "Cliente", "15/05/2026"),
        ("Coleta RCA + produção do MCO + Anexos I/II CONAMA 273", "Hábilis + Terceiros", "22/05 – 29/05/2026"),
        ("Plano de atendimento das 28 condicionantes", "Hábilis", "30/05/2026"),
        ("RCA consolidado + PAE", "Hábilis", "03/06 – 05/06/2026"),
        ("Relatório técnico consolidado (+ART Hábilis CRBio)", "Hábilis", "19/06/2026"),
    ...
    styled_run(doc.add_paragraph(), "Regularização Ambiental · Documento Consolidado Final · v2",
               size=9, color=CINZA_5)
    styled_run(doc.add_paragraph(),
               "Versão Consolidada 2.0 · Escopo refinado · Confidencial · Emitido em 22/04/2026 · Destinatário: Grupo Z+Z",
    ...
    callout(doc, "Capítulo adicional · oportunidade de continuidade",
            ...
            "contratado da renovação (R$ 1.280k–1.330k · §07). Inclui, além das frentes "
            "estruturais (ANP · IBAMA · NR-20 · PNRS · monitoramentos), o cadastro ANP "
            "atualizado do revendedor (CP 3.10) e o alvará sanitário municipal (se aplicável "
            "em zona rural). Está aqui para dar visibilidade ao Grupo Z+Z do que seguirá "
            "pendente após 26/06/2026. A formalização como serviço contratado é decisão do "
            "cliente.",
            kind="azul",
            bold_body_parts=["gestão continuada pós-protocolo", "Não integra o pacote",
                             "R$ 1.280k–1.330k", "cadastro ANP atualizado do revendedor (CP 3.10)",
                             "alvará sanitário municipal", "decisão do cliente"])
    ...
    heading_h3(doc, "11.2 · Frente ANP · Agência Nacional do Petróleo (inclui cadastro atualizado do revendedor · CP 3.10)")
    t = table_hdr(doc, ["Dimensão", "Detalhamento"], [4.0, 13.0])
    rows_anp = [
        ("Base normativa", "Res. ANP 41/2013 · Res. ANP 58/2014 · Res. ANP 20/2009 · CP 3.10 LAO 033/2020"),
        ("Obrigações", "Cadastro de revendedor atualizado (CP 3.10) · declaração anual de vendas · placa ao consumidor · certificado de coleta de óleo usado · aprovações de tanques/bombas"),
        ("Cadência", "Anual · contínua · pontual"),
        ("Custo anual estimado", "R$ 2k-5k"),
        ("Responsável", "Cliente (execução) + Hábilis (validação · se contratada)"),
        ("Consequência", "Auto ANP · multa · suspensão da autorização de revenda · bloqueio de NFs · impacto CP 3.10 da LAO"),
        ("Por que está aqui (e não na renovação LAO)", "A CP 3.10 exige manter o cadastro ANP atualizado como obrigação permanente do empreendimento, mas a atualização cadastral em si não é peça do dossiê de renovação — é obrigação correlata tratada em frente paralela. Ausência, porém, pode contaminar a análise do processo principal."),
    ]
    ...
    heading_h3(doc, "11.6 · Alvará Sanitário municipal (se aplicável · zona rural)")
    t = table_hdr(doc, ["Dimensão", "Detalhamento"], [4.0, 13.0])
    rows_alv = [
        ("Base normativa", "Legislação municipal de Guapó · Vigilância Sanitária · CP 3.8 LAO (demais licenças vigentes)"),
        ("Obrigações", "Emissão ou renovação do alvará sanitário municipal, se aplicável ao empreendimento em zona rural (depende da legislação municipal específica · validar junto à VISA Guapó)"),
        ("Cadência", "Renovação anual ou plurianual conforme município"),
        ("Custo anual estimado", "R$ 0,5k-2k (taxa municipal · se aplicável)"),
        ("Responsável", "Cliente (execução) + Hábilis (validação · se contratada)"),
        ("Consequência", "Suspensão automática da LAO por força da CP 3.8 se alguma licença correlata estiver vencida"),
        ("Por que está aqui", "CP 3.8 exige licenças correlatas vigentes, mas a emissão/renovação do alvará sanitário é frente paralela municipal · não é peça do dossiê de renovação LAO. Validação prioritária: confirmar junto à Prefeitura de Guapó se o alvará sanitário é exigível em zona rural."),
    ]
    for i, row in enumerate(rows_alv):
        add_row(t, list(row), zebra=(i % 2 == 1), bold_cols=[0])
    doc.add_paragraph()

    heading_h3(doc, "11.7 · Monitoramentos periódicos pós-LAO")
    t = table_hdr(doc, ["Dimensão", "Detalhamento"], [4.0, 13.0])
    rows_mon = [
    ...
    heading_h3(doc, "11.8 · Cronograma anual integrado · matriz 12 meses × frentes")
    ...
    heading_h3(doc, "11.9 · Custo anual estimado · consolidado")
    t = table_hdr(doc, ["Frente", "Piso anual", "Teto anual", "Observação"],
                   [6.0, 3.0, 3.0, 5.0])
    rows_custo = [
        ("ANP (§11.2)", "R$ 2k", "R$ 5k", "Inclui cadastro ANP atualizado (CP 3.10)"),
        ("IBAMA · CTF/APP + RAPP + TCFA (§11.3)", "R$ 3k", "R$ 8k", ""),
        ("NR-20 (§11.4)", "R$ 5k", "R$ 15k", "Bienal pode elevar ~R$ 10k"),
        ("PNRS/PGRS (§11.5)", "R$ 2k", "R$ 8k", "Lei 12.305/2010"),
        ("Alvará Sanitário municipal (§11.6)", "R$ 0,5k", "R$ 2k", "Se aplicável em zona rural"),
        ("Monitoramentos pós-LAO (§11.7)", "R$ 10k", "R$ 22k", "Laboratórios + reserva anual"),
        ("TOTAL ANUAL CONSOLIDADO", "R$ 20k", "R$ 60k", "Frente paralela · fora do CAPEX da renovação"),
    ]
    ...
    heading_h3(doc, "11.10 · Matriz de responsabilidades · Cliente × Hábilis × Terceiros")
    ...
    heading_h3(doc, "11.11 · Como formalizar a continuidade")
    ...
    callout(doc, "Por que esta seção está aqui",
            ...
            "renovação LAO (R$ 1.280k–1.330k · 3 frentes · 67 dias). A renovação resolve o "
            "problema imediato de 23/12/2026. O Compliance Paralelo resolve o problema eterno "
            "de manter a regularidade que sustentará as próximas 3 renovações (2032 · 2038 · "
            "2044). A Hábilis oferece visibilidade aqui · a contratação fica para a decisão "
            "estratégica do cliente após 26/06.",
            kind="azul",
    ...
    rows_mtx = [
        ...
        ("Hip. B · Dano estrutural ou subdimensionamento (PIOR CENÁRIO)",
         ...
         "Terceiro Eng. Civil até 15/05 + plano corretivo no dossiê · aditivo CAPEX · pode exigir nova LI (CP 4.12)."),
    ...
    callout(doc, "B.4 · Ação imediata pós-visita (mesmo dia, volta a Guapó)",
            ...
            "(A/B/C) · Reportar ao Grupo Z+Z em até 24 h · Atualizar o Plano das 28 CPs com a "
            "hipótese confirmada · Se Hipótese B, montar pedido de LI em paralelo à renovação "
            "(CP 4.12).",
            kind="amber",
    ...
    out_path = os.path.join(out_dir, "Documento_Consolidado_Final_AutoPostoAmerica_v2.docx")
    doc.save(out_path)
    print(f"DOCX salvo: {out_path}")
